  ...
  return (
    <section className="flex space-x-5 px-16">
      <div className="relative w-2/4 text-gray-600">
        <input onFocus={handleFocus} onBlur = {handleBlur} value={searchTerm} onChange= {handleChange} type="search" name="serchTerm" placeholder="Search" className="bg-white w-full h-10 px-5 pr-10 rounded-md text-sm focus:outline-none" />
