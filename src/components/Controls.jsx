...
const Controls = () => {
  ...
  return (
    <section className="flex space-x-1 md:space-x-5 px-16">
      ...
      <div onClick={() => filterCards("alphabet")} className={`bg-white flex items-center  border-gray-600 border-2 active-scale-90 cursor-pointer text-sm rounded-sm md:text-lg px-1 md:px-4 py-1 ${state.filter === 'alphabet' ? 'bg-gray-300' : ''}`}>
        <p>A to Z</p>
      </div>

      <div onClick={() => filterCards("youngest")} className={`bg-white flex items-center  border-gray-600 border-2 active-scale-90 cursor-pointer text-sm rounded-sm md:text-lg px-1 md:px-4 py-1 ${state.filter === 'youngest' ? 'bg-gray-300' : ''}`}>
        <p>Youngest</p>
      </div>

      <div onClick={() => filterCards("eldest")} className={`bg-white border-gray-600 flex items-center active-scale-90 cursor-pointer border-2 rounded-sm text-lg px-1 md:px-4 py-1 ${state.filter === 'eldest' ? 'bg-gray-300' : ''}`}>
        <p>Eldest</p>
      </div>
